...
export const initialState = [
    ...
    },
    {
        id: 2,
        image: tour1,
        title: 'Однажды в Тель-Авиве',
        place: 'Тель-Авив',
        date: new Date('May 30, 2022 11:00:00'),
        timeStart: new Date('May 30, 2022 05:00:00'),
        timeEnd: new Date('May 30, 2022 18:00:00'),
        price: 200,
        freeSpace: 4,
        totalSpace: 20,
        preview: 'Тель-Авив – город на побережье Средиземного моря, архитектурный облик которого формируют здания 1930-х годов в стиле баухаус. Большая их часть находится в районе Белый город, названном так по цвету фасадов.',
        description: 'Здесь же расположен мультимедийный Музей еврейского народа, где можно узнать о жизни еврейских общин во всем мире, и музей Эрец-Исраэль, в котором можно ознакомиться с археологическими находками, образцами фольклора и народных промыслов, а также посмотреть на раскопки филистимлянских поселений XII века до н. э. ',
        additionalInfo: 'Берите с собой воду',
        difficulty: 'Гид',
        meetingPoint: 'На тахане мерказит, ищите, как хотите.',
    },
    /*  {
        id: 3,
        //img: tour1.jpg,
